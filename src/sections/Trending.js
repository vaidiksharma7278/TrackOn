...
function Trending() {
  return (
    <div>
           {/* <div id="page3">
            <h1>Trending courses of the month</h1>
            <h3>These are the selected courses from YouTube to build your focus on learning rather than finding courses.
            </h3>
            <div id="cards">
                <div id="card1" class="card">
                    <div class="pic">
                        <img src="https://img.youtube.com/vi/gzdQDxzW2Tw/maxresdefault.jpg" alt=""/>
                    </div>
                    <h2>Build A Whatapp Clone With MERN Stack</h2>
                    <p>In this FREE LIVE training, Sonny and David will build a MERN Stack Whatsapp Clone LIVE and
                        deploy ...</p>
                    <i class="ri-team-fill"></i>
                    <span>2k</span>
                    <h4>students</h4>
                    <h5>view</h5>
                    <i id="a" class="ri-arrow-right-circle-fill"></i>
                </div>
                <div id="card2" class="card">
                    <div class="pic">
                        <img src="https://img.youtube.com/vi/x4DydJKVvQk/maxresdefault.jpg" alt=""/>
                    </div>
                    <h2>2022 Flutter Master Class  Travel App | Tutorial.... </h2>
                    <p>From this tutorial we build a flutter cubit state management app. We will build it step by step.
                        We ...</p>
                    <i class="ri-team-fill"></i>
                    <span>4k</span>
                    <h4>students</h4>
                ...
                <div id="card3" class="card">
                    <div class="pic">
                        <img src="https://img.youtube.com/vi/_xKCi5OI_Mg/maxresdefault.jpg" alt=""/>
                    </div>
                    <h2>File Sharing App With  Deployment In Node Js......</h2>
                    <p>This will be a file sharing app in node Js in Hindi. In this project we will build apis for a
                        file s...</p>
                    <i class="ri-team-fill"></i>
                    <span>1k</span>
                    <h4>students</h4>
